package com.sexybeast.michael.delve.Model_ID;
...
public class Example_ID {
    ...
    @Expose
    private List<Genre_ID> genres = new ArrayList<Genre_ID>();
    ...
    public List<Genre_ID> getGenres() {
        return genres;
    }

    public void setGenres(List<Genre_ID> genres) {
        this.genres = genres;
    }
